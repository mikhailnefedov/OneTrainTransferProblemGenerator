 ...
 */
public class RandomSolutionsFCMEvolutionarySolver extends EvolutionarySolver {
    ...
    public RandomSolutionsFCMEvolutionarySolver(OneTrainTransferProblem problem,
                                                ArrayList<HashMap<Passenger, Integer>> knownSolutions,
                                                SolverConfiguration solverConfiguration) {
        super(problem, RandomSolutionsFCMEvolutionarySolver.class.getSimpleName(), solverConfiguration);
